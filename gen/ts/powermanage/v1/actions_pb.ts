 ...
 */
export class PackageActionParams extends Message<PackageActionParams> {
  /**
   * e.g., "nginx", "vim"
   *
 ...
 */
export class PackageCurrentState extends Message<PackageCurrentState> {
  /**
 ...
 */
export class PreExecutionSnapshot extends Message<PreExecutionSnapshot> {
  /**
   * @generated from field: powermanage.v1.ActionId action_id = 1;
   */
  actionId?: ActionId;
 ...
 */
export class PackageSnapshot extends Message<PackageSnapshot> {
  /**
   * @generated from field: string package_name = 1;
   */
  packageName = "";
 ...
 */
export class RollbackResult extends Message<RollbackResult> {
  /**
