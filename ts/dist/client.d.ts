...
export declare class PowerManageClient {
     ...
     */
    beginRegistration(registrationCode: string): Promise<any>;
    /**
     * Complete WebAuthn registration.
     */
    finishRegistration(sessionId: string, optionsJson: string): Promise<any>;
    /**
     * Begin WebAuthn login.
     */
    beginLogin(username?: string): Promise<any>;
    /**
     * Complete WebAuthn login.
     */
    finishLogin(sessionId: string, optionsJson: string, useConditionalUI?: boolean): Promise<any>;
    /**
